...
import IntegrationsRealTimeWrapper from '@/components/integrations-real-time-wrapper'
...
export default async function IntegrationsPage({ params, searchParams }: PageProps) {
  ...
  return (
    <IntegrationsRealTimeWrapper tenantId={tenantId}>
